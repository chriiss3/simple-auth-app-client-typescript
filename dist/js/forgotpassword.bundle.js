...
(0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.verifyAccessToken)(true, _constants__WEBPACK_IMPORTED_MODULE_2__.PAGES.myAccount);
const handleFormSubmit = (e) => {
    ...
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validateInput)(emailValue, emailError, emailInput, emailLabel))
        return;
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            emailInput.value = "";
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.redirectToPage)(_constants__WEBPACK_IMPORTED_MODULE_2__.PAGES.login);
        }
        catch (err) {
            // if (isAxiosError(e)) {
            //   if (e.response) {
