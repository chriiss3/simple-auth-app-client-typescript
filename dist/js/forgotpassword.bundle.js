...
console.log(document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_2__.SELECTORS.fieldError));
...
const handleFormSubmit = (event) => {
    ...
    if ((0,_utils_formValidation__WEBPACK_IMPORTED_MODULE_1__.validateField)(emailValue, emailFieldError, emailInput, emailLabel))
        return;
