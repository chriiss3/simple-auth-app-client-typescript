...
const handleFormSubmit = (event) => {
    ...
    if ((0,_utils_formValidation__WEBPACK_IMPORTED_MODULE_1__.validateFields)(labels, inputs, fieldsError))
        return;
    if ((0,_utils_formValidation__WEBPACK_IMPORTED_MODULE_1__.validateEmail)(emailValue, dataError, emailInput, emailLabel))
        return;
        ...
        try {
            ...
            if (err instanceof axios__WEBPACK_IMPORTED_MODULE_4__.AxiosError) {
                ...
                if (errorMessage === _constants__WEBPACK_IMPORTED_MODULE_3__.CLIENT_ERROR_MESSAGES.accountNotFound) {
                    (0,_utils_formValidation__WEBPACK_IMPORTED_MODULE_1__.showDataError)(dataError, emailInput, emailLabel, errorMessage);
                }
