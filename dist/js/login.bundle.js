...
const handleFormSubmit = (event) => {
    ...
    (0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.removeFieldsError)(errorMessages, inputs, labels, responseError);
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validateInputs)(labels, inputs, errorMessages))
        return;
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validateEmail)(emailValue, responseError, emailInput, emailLabel))
        return;
