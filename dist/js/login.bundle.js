...
const verifyAccessToken = async (redirect, toastNotif) => {
    try {
...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/ts/utils/index.ts");
/* harmony import */ var _utils_formValidations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/formValidations */ "./src/ts/utils/formValidations.ts");
/* harmony import */ var _utils_togglePasswordVisibility__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/togglePasswordVisibility */ "./src/ts/utils/togglePasswordVisibility.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../constants */ "./src/ts/constants.ts");
...
// const accessTokenExpireTime: number = 1
// const sendNewAccessTokenTime: number = 1
// const backupAccessToken: string = "" // localStorage
console.log(navigator.onLine);
// Ejecuar primero getNewAccessToken luego verifyAccessToken al cargar la pagina
// Cierre de sesion: 2:00 PM
// El codigo se ejecura a las 1:47 PM (si se esta offline, se ejcutara cuando vuelva a esta online)
// Si ya no esta el accessToken en cookies tengo a backupAccessToken para validar y enviar uno nuevo
// Almacenar en localStorage la fecha o tiempo restante de expiracion
const date = new Date(); // fecha actual
const accessTokenExpiracionDate = new Date(); // localStorage
// En todas las paginas irá este codigo 
// Si es igual o menor
if (date === accessTokenExpiracionDate) {
    if (navigator.onLine) {
        // const getNewAccessToken = () => {
        // }
    }
}
(0,_utils__WEBPACK_IMPORTED_MODULE_0__.verifyAccessToken)(true, toastNotif);
const handleFormSubmit = (event) => {
    ...
    (0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.removeFieldsError)(fieldsError, inputs, labels);
    (0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.removeFormErrors)(dataError, inputs, labels);
    if ((0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.validateFields)(labels, inputs, fieldsError))
        return;
    if ((0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.validateEmail)(emailValue, dataError, emailInput, emailLabel))
        return;
    const login = async () => {
        ...
        try {
            ...
            const res = await _utils__WEBPACK_IMPORTED_MODULE_0__.api.post("/auth/login", formData);
            submitButton.classList.remove(_constants__WEBPACK_IMPORTED_MODULE_3__.CSS_CLASSES.loading);
            (0,_utils__WEBPACK_IMPORTED_MODULE_0__.showToast)(toastNotif, res.data.message);
            (0,_utils__WEBPACK_IMPORTED_MODULE_0__.redirectToPage)(_constants__WEBPACK_IMPORTED_MODULE_3__.PAGES.home);
        }
        catch (err) {
            // clearTimeout(timeoutId);
            submitButton.classList.remove(_constants__WEBPACK_IMPORTED_MODULE_3__.CSS_CLASSES.loading);
            if (err instanceof axios__WEBPACK_IMPORTED_MODULE_4__.AxiosError) {
                if (!err.response) {
                    (0,_utils__WEBPACK_IMPORTED_MODULE_0__.showToast)(toastNotif, "Ocurrio un error desconocido");
                    return;
                }
                const errorMessage = err.response.data.error;
                if (errorMessage === _constants__WEBPACK_IMPORTED_MODULE_3__.CLIENT_ERROR_MESSAGES.accountNotFound) {
                    (0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.addFormError)(dataError, emailInput, emailLabel, errorMessage);
                }
                if (errorMessage === _constants__WEBPACK_IMPORTED_MODULE_3__.CLIENT_ERROR_MESSAGES.incorrectPassword) {
                    (0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.addFormError)(dataError, passwordInput, passwordLabel, errorMessage);
                }
            }
            else {
                (0,_utils__WEBPACK_IMPORTED_MODULE_0__.showToast)(toastNotif, "La solicitud ha tardado demasiado, inténtalo nuevamente.");
            }
        }
    };
    login();
};
eyeIcon.addEventListener("click", () => (0,_utils_togglePasswordVisibility__WEBPACK_IMPORTED_MODULE_2__.handleEyeIcon)(passwordInput, eyeIcon, eyeOffIcon));
eyeOffIcon.addEventListener("click", () => (0,_utils_togglePasswordVisibility__WEBPACK_IMPORTED_MODULE_2__.handleEyeOffIcon)(passwordInput, eyeIcon, eyeOffIcon));
