...
const handleFormSubmit = (e) => {
    ...
    if ((0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.validateEmail)(emailValue, dataError, emailInput, emailLabel))
        return;
    if ((0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.validatePasswordLength)(passwordValue, dataError, passwordInput, passwordLabel))
        return;
    const register = async () => {
        ...
        try {
            const res = await _utils__WEBPACK_IMPORTED_MODULE_0__.api.post("/auth/register", formData);
