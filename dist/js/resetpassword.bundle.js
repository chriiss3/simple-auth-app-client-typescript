...
const handleFormSubmit = (event) => {
    ...
    const newPasswordInput = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTORS.newPasswordInput);
    const confirmNewPasswordInput = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTORS.confirmNewPasswordInput);
    ...
    const newPasswordLabel = labels[0];
    const confirmNewPasswordValue = confirmNewPasswordInput.value.trim();
    const confirmNewPasswordLabel = labels[1];
    ...
    if ((0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.validateFields)(labels, inputs, fieldsError))
        return;
    if ((0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.validatePasswordMatch)(newPasswordValue, confirmNewPasswordValue, dataError, confirmNewPasswordInput, confirmNewPasswordLabel))
        return;
    if ((0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.validatePasswordLength)(newPasswordValue, dataError, newPasswordInput, newPasswordLabel))
        return;
    const resetPassword = async () => {
        ...
        try {
            const res = await _utils__WEBPACK_IMPORTED_MODULE_0__.api.post("/auth/reset-password", formData, {
                headers: {
            ...
            if (err instanceof axios__WEBPACK_IMPORTED_MODULE_4__.AxiosError) {
                ...
                (0,_utils_formValidations__WEBPACK_IMPORTED_MODULE_1__.addFormError)(dataError, newPasswordInput, newPasswordLabel, errorMessage);
            }
        }
    };
    resetPassword();
...
passwordInputs.forEach((passwordInput, i) => {
    eyeIcons[i].addEventListener("click", () => (0,_utils_togglePasswordVisibility__WEBPACK_IMPORTED_MODULE_2__.handleEyeIcon)(passwordInput, eyeIcons[i], eyeOffIcons[i]));
    eyeOffIcons[i].addEventListener("click", () => (0,_utils_togglePasswordVisibility__WEBPACK_IMPORTED_MODULE_2__.handleEyeOffIcon)(passwordInput, eyeIcons[i], eyeOffIcons[i]));
});
