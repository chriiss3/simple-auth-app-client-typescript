...
/* harmony import */ var _utils_form_validation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/form-validation */ "./src/ts/utils/form-validation.ts");
/* harmony import */ var _utils_toggle_password_visibility__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/toggle-password-visibility */ "./src/ts/utils/toggle-password-visibility.ts");
...
passwordInputs.forEach((passwordInput, i) => {
    eyeIcons[i].addEventListener("click", () => (0,_utils_toggle_password_visibility__WEBPACK_IMPORTED_MODULE_2__.handleEyeIcon)(passwordInput, eyeIcons[i], eyeOffIcons[i]));
    eyeOffIcons[i].addEventListener("click", () => (0,_utils_toggle_password_visibility__WEBPACK_IMPORTED_MODULE_2__.handleEyeOffIcon)(passwordInput, eyeIcons[i], eyeOffIcons[i]));
});
const handleFormSubmit = (e) => {
    ...
    const confirmPasswordInput = document.querySelector(_constants__WEBPACK_IMPORTED_MODULE_3__.SELECTORS.confirmPasswordInput);
    ...
    (0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.removeFieldsError)(errorMessages, inputs, labels, globalError);
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validateInputs)(labels, inputs, errorMessages))
        return;
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.confirmPasswordMatch)(passwordValue, confirmPasswordValue, globalError, confirmPasswordInput, confirmPasswordLabel))
        return;
    if ((0,_utils_form_validation__WEBPACK_IMPORTED_MODULE_1__.validatePasswordLength)(passwordValue, globalError, passwordInput, passwordLabel))
        return;
    const dataFetching = async () => {
        ...
        try {
            ...
            (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.redirectToPage)(_constants__WEBPACK_IMPORTED_MODULE_3__.PAGES.myAccount);
        }
        catch (err) {
            // if (isAxiosError(e)) {
            //   if (e.response) {
