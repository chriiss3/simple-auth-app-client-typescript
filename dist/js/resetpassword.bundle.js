...
/* harmony import */ var _utils_formValidation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/formValidation */ "./src/ts/utils/formValidation.ts");
...
const handleFormSubmit = (event) => {
    ...
    if ((0,_utils_formValidation__WEBPACK_IMPORTED_MODULE_1__.validateFields)(labels, inputs, fieldsError))
        return;
    if ((0,_utils_formValidation__WEBPACK_IMPORTED_MODULE_1__.confirmPasswordMatch)(passwordValue, confirmPasswordValue, dataError, confirmPasswordInput, confirmPasswordLabel))
        return;
    if ((0,_utils_formValidation__WEBPACK_IMPORTED_MODULE_1__.validatePasswordLength)(passwordValue, dataError, passwordInput, passwordLabel))
        return;
    const dataFetching = async () => {
        ...
        try {
            ...
            if (err instanceof axios__WEBPACK_IMPORTED_MODULE_4__.AxiosError) {
                ...
                (0,_utils_formValidation__WEBPACK_IMPORTED_MODULE_1__.showDataError)(dataError, passwordInput, passwordLabel, errorMessage);
            }
        }
    };
    dataFetching();
