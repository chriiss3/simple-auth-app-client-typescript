...
const passwordInputs = document.querySelectorAll(_constants__WEBPACK_IMPORTED_MODULE_1__.SELECTORS.input);
const eyeIcons = document.querySelectorAll(_constants__WEBPACK_IMPORTED_MODULE_1__.SELECTORS.eyeIcon);
const eyeOffIcons = document.querySelectorAll(_constants__WEBPACK_IMPORTED_MODULE_1__.SELECTORS.eyeOffIcon);
...
const getUserData = async () => {
    ...
    const user = await (0,_utils__WEBPACK_IMPORTED_MODULE_0__.verifyAccessToken)(false, toastNotif);
    if (user) {
...
const handleLogoutButton = () => {
    const logout = async () => {
        try {
            const res = await _utils__WEBPACK_IMPORTED_MODULE_0__.api.post("/auth/logout");
            (0,_utils__WEBPACK_IMPORTED_MODULE_0__.showToast)(toastNotif, res.data.message);
            (0,_utils__WEBPACK_IMPORTED_MODULE_0__.redirectToPage)(_constants__WEBPACK_IMPORTED_MODULE_1__.PAGES.login);
        }
        catch (err) {
            if (err instanceof axios__WEBPACK_IMPORTED_MODULE_3__.AxiosError) {
                if (!err.response) {
